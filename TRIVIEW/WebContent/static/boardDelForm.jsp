...
<!-- 윗칸 -> 본문 -->
			...
			<main class="content">
				...
				<!-- 드롭다운 -->
<form action ="boardDel.jsp?pageNum=<%=request.getParameter("pageNum") %>" method="post">

  <input type="hidden" name="num" value="<%=request.getParameter("num") %>" >
  
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0"> 게시물을 삭제하시겠습니까?</h5>
								</div>
...
<!-- 메모끝 -->	
 ...
 <!-- 어디로 보낼지 - 처리페이지 -->                          
                                        <input type="submit" class="btn btn-primary tm-btn tm-btn-search text-uppercase" id="boardSubmit" value="삭제하기">
